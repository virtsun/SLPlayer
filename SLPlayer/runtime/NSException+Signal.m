...
+ (void)schedule{
    ...
    _timer = dispatch_source_create(DISPATCH_SOURCE_TYPE_TIMER, 0, 0, dispatch_queue_create("Signal", 0));
    dispatch_source_set_timer(_timer,dispatch_walltime(NULL, DISPATCH_TIME_NOW),interval, 0); //每秒执行
    dispatch_source_set_event_handler(_timer, ^{
        [NSException listenSignal];
    });
